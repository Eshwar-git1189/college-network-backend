      ...
      <div className="py-4 px-10 border border-gray-400 w-full flex justify-between my-5 text-xl bg-white rounded-xl">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`p-1 border border-gray-300 rounded-lg ${text === "Catch Up with Friends" ? "bg-blue-800 text-white" : ""}`}
          >
            Friends
          </button>
          ...
          <button
            ...
            className={`p-1 border border-gray-300 rounded-lg ${text === "Pending Request" ? "bg-blue-800 text-white" : ""}`}
          >
            Pending
          </button>
        </div>
